...
<table cellpadding="0" cellspacing="0" align="center" width="<?php echo ($mg2->width+10);?>">
<tr>
...
<div align="center">
	<div class="description" style="width:<?php echo ($mg2->width+10);?>px"><?php $mg2->output('description');?></div>
</div>
<br />
