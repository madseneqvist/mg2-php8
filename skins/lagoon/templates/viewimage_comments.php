...
<tr>
	<td align="center">
		<br /><b><?php echo $mg2->lang['comment'];?></b><br />
		<textarea cols="60" rows="5" name="body" id="body" class="comment-textfield"><?php echo $workon[3];?></textarea>
	</td>
</tr>
<tr>
	<td align="center">
		<br /><b><?php echo $mg2->lang['name'];?></b><br />
		<input type="text" size="60" maxlength="90" name="name" id="name" value="<?php echo $workon[1];?>" class="comment-textfield" />
	</td>
</tr>
<tr>
	<td align="center">
		<br /><b><?php echo $mg2->lang['email'];?></b><br />
		<input type="text" size="60" maxlength="90" name="email" id="email" value="<?php echo $workon[2];?>" class="comment-textfield" />
	</td>
</tr>
<?php
// VIEW IMAGE CAPTCHA
