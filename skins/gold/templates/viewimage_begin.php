...
<tr>
	<td class="iconbar">
		<?php $mg2->slideshowicon('align="top"');?>&nbsp;&nbsp;<?php $mg2->gallerynavigation(' | ');?>
	</td>
</tr>
</table>
<br />
...
<table cellpadding="0" cellspacing="0" align="center" width="<?php echo ($mg2->width+40);?>">
<tr>
	<td class="viewimage" align="center">
		<a href="<?php $mg2->output('link');?>" target="<?php $mg2->output('target');?>" title="<?php echo $title;?>"><img src="<?php $mg2->output('imagefile');?>" border="0" width="<?php $mg2->output('width');?>" height="<?php $mg2->output('height');?>" alt="" /></a></td>
</tr>
</table>
<div align="center">
	<div class="description" style="width:<?php echo ($mg2->width+40);?>px"><?php $mg2->output('description');?></div>
</div>
<br />
