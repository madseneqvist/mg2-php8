...
<tr>
	<td class="viewimage" align="center">
		<a href="<?php $mg2->output('link');?>" target="<?php $mg2->output('target');?>" title="<?php echo $title;?>"><img src="<?php $mg2->output('imagefile');?>" border="0" width="<?php $mg2->output('width');?>" height="<?php $mg2->output('height');?>" alt="" /></a>
	</td>
</tr>
</table>
<div align="center">
