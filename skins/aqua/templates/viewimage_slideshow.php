...
<tr>
	<td class="viewimage">
		<a href="<?php echo $nexturl;?>" target="<?php $mg2->output('target');?>" title="<?php $mg2->output('tooltip');?>"><img src="<?php $mg2->output('imagefile');?>" border="0" width="<?php $mg2->output('width');?>" height="<?php $mg2->output('height');?>" alt="" /></a>
	</td>
</tr>
</table>
<br />
